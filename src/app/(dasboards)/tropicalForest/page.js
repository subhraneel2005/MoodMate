  ...
  if(!user){
    ...
    return(
        <main className="min-h-screen w-full flex select-none">
          ...
          <h1 className="text-3xl absolute top-9 left-20">Hey {user?.displayName}👋 welcome to the forest 🌳</h1>
            ...
            <div className="block space-y-4">
              <h1 className="text-3xl text-center text-green-400 mt-4">Your Journals 📖</h1>
              <button className="bg-green-950 text-green-500 px-3 py-2 rounded-xl">Add Journal</button>
            </div>
          </div>
        </main>
    )
