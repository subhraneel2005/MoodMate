  ...
  if(!user){
    ...
    return(
        <main className="min-h-screen w-full flex select-none">
          <div className="md:w-[20%] block bg-teal-800 py-6 px-2">
             <ul className="block space-y-8 text-xl cursor-pointer mt-52">
                <li className="px-5 py-2 rounded-lg border-2 bg-teal-600 hover:bg-teal-800 duration-300">Write today's journal</li>
                <li className="px-5 py-2 rounded-lg border-2 bg-blue-500 hover:bg-blue-800 duration-300">View Profile</li>
                <Popover>
                  <PopoverTrigger>
          ...
          <h1 className="text-3xl absolute top-9 left-20">Hey {user?.displayName}👋 welcome to the Oceans 🌊</h1>
            ...
            <div className="block space-y-4">
              <h1 className="text-3xl text-center font-bold text-sky-200 mt-4">Your Journals 📖</h1>
              <button className="bg-stone-950 text-blue-600 px-3 py-2 rounded-xl">Add Journal</button>
            </div>
          </div>
        </main>
    )
